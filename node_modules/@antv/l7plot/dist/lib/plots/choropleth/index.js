...
var Choropleth = /** @class */ (function (_super) {
    ...
    Choropleth.prototype.createLayers = function (source) {
        ...
        if (this.options.chinaBorder) {
            var _a = this.createCountryBoundaryLayer(this.chinaBoundaryData, this.options), chinaBoundaryLayer = _a.chinaBoundaryLayer, chinaDisputeBoundaryLayer = _a.chinaDisputeBoundaryLayer;
    ...
    Choropleth.prototype.createCountryBoundaryLayer = function (data, plotConfig) {
        var _a = (0, layer_1.createCountryBoundaryLayer)(data, plotConfig), chinaBoundaryLayer = _a.chinaBoundaryLayer, chinaDisputeBoundaryLayer = _a.chinaDisputeBoundaryLayer;
