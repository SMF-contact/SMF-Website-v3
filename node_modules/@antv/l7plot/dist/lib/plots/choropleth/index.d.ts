...
import { ChoroplethOptions, ChoroplethSourceOptions, DrillStack, ViewLevel, DrillStepConfig, FeatureCollection } from './types';
...
export declare class Choropleth extends Plot<ChoroplethOptions> {
    ...
    protected parserSourceConfig(source: ChoroplethSourceOptions): {
        ...
        sourceCFG: {
            transforms?: import("@antv/l7-core/es/services/source/ISourceService").ITransform[] | undefined;
        };
    };
    /**
     * 创建 source 实例
