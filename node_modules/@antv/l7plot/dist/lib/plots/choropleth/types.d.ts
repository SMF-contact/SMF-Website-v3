 ...
 */
export declare type FeatureCollection = GeoJSON.FeatureCollection;
/**
 * 行政地理数据地址
 */
 ...
 * 中国国界样式配置
 */
export declare type ChinaBoundaryStyle = Partial<typeof CHINA_BOUNDARY_STYLE>;
/**
 * 地理元数据关联
 */
export declare type JoinBy = {
    /**
     * 业务元数据地理字段
     */
    sourceField: string;
 ...
 * 钻取维度配置项
 */
export declare type DrillStepConfig = Partial<Pick<AreaLayerOptions, 'color' | 'style' | 'state'>> & Pick<PlotOptions, 'label' | 'tooltip'> & {
    source?: Partial<ChoroplethSourceOptions>;
};
/**
 * 钻取维度
 */
export declare type DrillStep = DrillStepConfig & {
    /**
     * 行政级别
     */
 ...
 * 行政层级数据
 */
export declare type DrillStack = Required<ViewLevel> & {
