...
var MapboxService = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_l7Core.TYPES.MapConfig), _dec3 = (0, _inversify.inject)(_l7Core.TYPES.IGlobalConfigService), _dec4 = (0, _inversify.inject)(_l7Core.TYPES.ICoordinateSystemService), _dec5 = (0, _inversify.inject)(_l7Core.TYPES.IEventEmitter), _dec(_class = (_class2 = function () {
  function MapboxService() {
    ...
    (0, _defineProperty2.default)(this, "version", _version.Version.MAPBOX);
  ...
  (0, _createClass2.default)(MapboxService, [{
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$config = this.config, _this$config$id = _this$config.id, id = _this$config$id === void 0 ? 'map' : _this$config$id, _this$config$attribut = _this$config.attributionControl, attributionControl = _this$config$attribut === void 0 ? false : _this$config$attribut, _this$config$style = _this$config.style, style = _this$config$style === void 0 ? 'light' : _this$config$style, _this$config$token = _this$config.token, token = _this$config$token === void 0 ? MAPBOX_API_KEY : _this$config$token, _this$config$rotation = _this$config.rotation, rotation = _this$config$rotation === void 0 ? 0 : _this$config$rotation, mapInstance = _this$config.mapInstance, rest = (0, _objectWithoutProperties2.default)(_this$config, _excluded);
    ...
    value: function meterToCoord(center, outer) {
      var centerLnglat = new _mapboxGl.default.LngLat(center[0], center[1]);
      var outerLnglat = new _mapboxGl.default.LngLat(outer[0], outer[1]);
      var meterDis = centerLnglat.distanceTo(outerLnglat);

      var centerMercator = _mapboxGl.default.MercatorCoordinate.fromLngLat({
        lng: center[0],
        lat: center[1]
      });

      var outerMercator = _mapboxGl.default.MercatorCoordinate.fromLngLat({
        lng: outer[0],
        lat: outer[1]
      });
