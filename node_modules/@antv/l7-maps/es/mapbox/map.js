...
var _excluded = ["id", "attributionControl", "style", "token", "rotation", "mapInstance"];
...
var MAPBOX_API_KEY = 'pk.eyJ1IjoibHp4dWUiLCJhIjoiY2tvaWZuM2s4MWZuYjJ1dHI5ZGduYTlrdiJ9.DQCfMRbZzx0VSwecQ69McA';
var MapboxService = (_dec = injectable(), _dec2 = inject(TYPES.MapConfig), _dec3 = inject(TYPES.IGlobalConfigService), _dec4 = inject(TYPES.ICoordinateSystemService), _dec5 = inject(TYPES.IEventEmitter), _dec(_class = (_class2 = function () {
  function MapboxService() {
    var _this = this;

    _classCallCheck(this, MapboxService);

    _defineProperty(this, "version", Version.MAPBOX);
  ...
  _createClass(MapboxService, [{
    ...
    value: function lngLatToMercator(lnglat, altitude) {
      var _window$mapboxgl$Merc = window.mapboxgl.MercatorCoordinate.fromLngLat(lnglat, altitude),
          _window$mapboxgl$Merc2 = _window$mapboxgl$Merc.x,
          x = _window$mapboxgl$Merc2 === void 0 ? 0 : _window$mapboxgl$Merc2,
          _window$mapboxgl$Merc3 = _window$mapboxgl$Merc.y,
          y = _window$mapboxgl$Merc3 === void 0 ? 0 : _window$mapboxgl$Merc3,
          _window$mapboxgl$Merc4 = _window$mapboxgl$Merc.z,
          z = _window$mapboxgl$Merc4 === void 0 ? 0 : _window$mapboxgl$Merc4;
    ...
    value: function getModelMatrix(lnglat, altitude, rotate) {
      ...
      var modelAsMercatorCoordinate = window.mapboxgl.MercatorCoordinate.fromLngLat(lnglat, altitude);
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$config = this.config, _this$config$id = _this$config.id, id = _this$config$id === void 0 ? 'map' : _this$config$id, _this$config$attribut = _this$config.attributionControl, attributionControl = _this$config$attribut === void 0 ? false : _this$config$attribut, _this$config$style = _this$config.style, style = _this$config$style === void 0 ? 'light' : _this$config$style, _this$config$token = _this$config.token, token = _this$config$token === void 0 ? MAPBOX_API_KEY : _this$config$token, _this$config$rotation = _this$config.rotation, rotation = _this$config$rotation === void 0 ? 0 : _this$config$rotation, mapInstance = _this$config.mapInstance, rest = _objectWithoutProperties(_this$config, _excluded);
                ...
                if (mapInstance) {
                  ...
                  this.map = new window.mapboxgl.Map(_objectSpread({
    ...
    value: function meterToCoord(center, outer) {
      ...
      var outerLnglat = new mapboxgl.LngLat(outer[0], outer[1]);
      var meterDis = centerLnglat.distanceTo(outerLnglat);
      var centerMercator = mapboxgl.MercatorCoordinate.fromLngLat({
        lng: center[0],
        lat: center[1]
      });
      var outerMercator = mapboxgl.MercatorCoordinate.fromLngLat({
        lng: outer[0],
        lat: outer[1]
      });
      var x1 = centerMercator.x,
          y1 = centerMercator.y;
      var x2 = outerMercator.x,
          y2 = outerMercator.y;
      var coordDis = Math.sqrt(Math.pow(x1 - x2, 2) + Math.pow(y1 - y2, 2)) * 4194304 * 2;
