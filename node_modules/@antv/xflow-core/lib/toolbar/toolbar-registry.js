...
var ToolbarRegistry = /** @class */ (function () {
    function ToolbarRegistry() {
        ...
        this.createToolbarGroupModel = function (groups) {
            var groupModels = groups.map(function (group) {
                ...
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, group), { items: items.map(function (item) { return _this.createToolbarModel({ id: item.id }); }).filter(function (i) { return !!i; }) });
            });
            return groupModels;
        };
    }
    ...
    ToolbarRegistry.prototype.createToolbarModel = function (option) {
        ...
        var toolbarItem = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { isEnabled: isEnabled, isVisible: isVisible, iconName: item.iconName, text: item.text });
        return toolbarItem;
    };
    ...
    ToolbarRegistry = (0, tslib_1.__decorate)([
