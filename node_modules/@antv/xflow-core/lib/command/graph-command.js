...
var GraphCommandRegistry = /** @class */ (function () {
    function GraphCommandRegistry(contributionProvider) {
         ...
         */
        this.undoCommand = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var cmd;
         ...
         */
        this.redoCommand = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var cmd;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    GraphCommandRegistry = (0, tslib_1.__decorate)([
        (0, mana_syringe_1.singleton)({
            contrib: [interface_1.IFrontendApplicationContribution, interface_2.IGraphCommandService],
        }),
        (0, tslib_1.__param)(0, (0, mana_syringe_1.contrib)(interface_2.IGraphCommandContribution)),
