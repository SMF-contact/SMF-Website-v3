...
var FrontendApplication = /** @class */ (function () {
    function FrontendApplication() {
        ...
        /** 获取画布配置项 */
        this.getGraphData = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graph, cells;
        ...
        /** 获取画布所有节点 */
        this.getAllNodes = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graph;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphProvider.getGraphInstance()];
        ...
        /** 获取画布节点 */
        this.getNodeById = function (nodeId) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graph;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphProvider.getGraphInstance()];
        ...
        /** 获取画布所有连线 */
        this.getAllEdges = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graph;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphProvider.getGraphInstance()];
        ...
        /** 获取画布连线 */
        this.getEdgeById = function (edgeId) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graph;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphProvider.getGraphInstance()];
        ...
        /** 更新节点样式 */
        this.updateNodeAttrs = function (node, attrs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var x6Node;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        /** 更新连线样式 */
        this.updateEdgeAttrs = function (edge, attrs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var x6Edge;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        /** 平移画布 */
        this.translateGraph = function (tx, ty) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
