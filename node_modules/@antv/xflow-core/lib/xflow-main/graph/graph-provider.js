...
var GraphManager = /** @class */ (function () {
    function GraphManager() {
        var _this = this;
        /** 处理画布实例的销毁 */
        this.toDisposce = new disposable_1.DisposableCollection();
        /** 储存画布实例 */
        this.graphMap = new Map();
        /** 获取X6 Graph 实例 */
        this.getGraph = function (graphId) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graphDefer, options, hooks_2, mergedOptions, graphContainer, edgeRender, nodeRender, edgeTypeParser_1, edgeRenderMap_1, clientHeight, clientWidth, commandService_1, modelService_1, graph_1;
            var _this = this;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, hooks_2.graphOptions.call(options.x6Options)];
                    case 2:
                        mergedOptions = _a.sent();
                        graphContainer = options.graphContainer, edgeRender = options.edgeRender, nodeRender = options.nodeRender, edgeTypeParser_1 = options.edgeTypeParser;
                    ...
                    case 6:
                        ...
                        graph_1 = new x6_1.Graph((0, tslib_1.__assign)((0, tslib_1.__assign)({ container: graphContainer, width: clientWidth, height: clientHeight }, mergedOptions), { 
                    ...
                    case 7:
                        ...
                        graph_1.on('node:moved', function (_a) {
                            ...
                            node.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, nodeData), { x: position === null || position === void 0 ? void 0 : position.x, y: position === null || position === void 0 ? void 0 : position.y }));
                        });
                        graph_1.on('node:resized', function (_a) {
                            var node = _a.node;
                            var nodeData = node.getData();
                            var size = node.size();
                            node.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, nodeData), { width: size === null || size === void 0 ? void 0 : size.width, height: size === null || size === void 0 ? void 0 : size.height }));
                        });
                        this.toDisposce.push(disposable_1.Disposable.create(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                            return (0, tslib_1.__generator)(this, function (_a) {
                                switch (_a.label) {
        ...
        this.renderEdgeReactLabel = function (args) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    GraphManager = (0, tslib_1.__decorate)([
...
var registerGraphModule = function (register) {
    ...
    register(exports.IGraphProvider, {
        ...
        useDynamic: function (context) {
            return {
                getGraphInstance: function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                ...
                getGraphOptions: function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    register(exports.ICommandServiceProvider, {
        ...
        useDynamic: function (context) {
            return {
                getCommandService: function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                    var commandService;
                    return (0, tslib_1.__generator)(this, function (_a) {
    ...
    register(exports.IModelServiceProvider, {
        ...
        useDynamic: function (context) {
            return {
                getModelService: function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                    var modelService;
                    return (0, tslib_1.__generator)(this, function (_a) {
