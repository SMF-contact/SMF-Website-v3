...
Object.defineProperty(exports, "XFlowAppExtension", { enumerable: true, get: function () { return app_extension_module_1.XFlowAppExtensionMoudle; } });
...
var XFlow = function (props) {
    ...
    react_1.default.useEffect(function () {
        ...
        app.start().then(function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, app.commandService.executeCommand(command_contributions_1.XFlowGraphCommands.GRAPH_LAYOUT.id, (0, tslib_1.__assign)({ graphData: graphData }, graphLayout))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
        ...
        /** unmount */
        var destroy = function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
    ...
    /** 自动渲染画布内容 */
    react_1.default.useEffect(function () {
        var fn = function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var x6Graph;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, appRef.commandService.executeCommand(command_contributions_1.XFlowGraphCommands.GRAPH_LAYOUT.id, (0, tslib_1.__assign)({ graphData: graphData }, graphLayout))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
    ...
    /** classname */
    var appClzName = classnames_1.default.apply(void 0, (0, tslib_1.__spreadArray)(['xflow-app-workspace',
    ...
    return (react_1.default.createElement(app_context_1.XFlowAppInternalProvider, { app: appRef },
        react_1.default.createElement(extension_context_1.ExtensionRegistryContext.Provider, { value: extensionRegistry },
            react_1.default.createElement("div", { className: appClzName, id: extensionRegistry.getInstaceId(), style: style },
