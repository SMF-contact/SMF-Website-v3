...
var XFlowAppInternalProvider = function (props) {
    ...
    return (react_1.default.createElement(exports.XFlowAppContext.Provider, { value: (0, tslib_1.__assign)({}, appContainer) }, props.children));
};
...
var XFlowAppProvider = function (_a) {
    ...
    // add callback
    appContainer.onAppChange(function () { return setTick(0); });
    return react_1.default.createElement(exports.XFlowAppContext.Provider, { value: (0, tslib_1.__assign)({}, appContainer) }, children);
};
