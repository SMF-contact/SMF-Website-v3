...
var MODELS = (0, tslib_1.__importStar)(require("../constant"));
var GraphModelContribution = /** @class */ (function () {
    function GraphModelContribution() {
        var _this = this;
        /** 获取画布实例 */
        this.getGraphInstance = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    GraphModelContribution.prototype.registerModel = function (registry) {
        ...
        registry.registerModel({
            ...
            watchChange: function (self) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                return (0, tslib_1.__generator)(this, function (_a) {
        ...
        registry.registerModel({
            ...
            watchChange: function (self, modelService) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                var cellsModel;
                return (0, tslib_1.__generator)(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, cellsModel.watch(function (cells) {
                                    ...
                                    self.setValue((0, tslib_1.__spreadArray)([], cells, true).pop() || null);
                                })];
                    }
                });
            }); },
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            disposable = model.watch(function (nodes) {
                                self.setValue((0, tslib_1.__spreadArray)([], nodes, true).pop() || null);
                            });
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            onChange = function (e) {
                                ...
                                self.setValue((0, tslib_1.__assign)((0, tslib_1.__assign)({}, e), { zoomFactor: factor }));
                            };
    ...
    GraphModelContribution = (0, tslib_1.__decorate)([
