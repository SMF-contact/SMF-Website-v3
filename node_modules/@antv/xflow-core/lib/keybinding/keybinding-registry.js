...
var KeyBindingRegistry = /** @class */ (function () {
    function KeyBindingRegistry() {
        ...
        this.registerExternalKeybindings = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
         ...
         * @param id contextId
         */
        this.enableKeyBindings = function (keybindingId) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
         ...
         * 执行command
         */
        this.runCommand = function (keybinding) { return function (e) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    KeyBindingRegistry = (0, tslib_1.__decorate)([
