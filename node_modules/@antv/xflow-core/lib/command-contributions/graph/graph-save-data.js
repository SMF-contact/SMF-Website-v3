...
var GraphSaveDataCommand = /** @class */ (function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        hooks = ctx.getHooks();
                        /** 执行hooks */
                        return [4 /*yield*/, hooks.saveGrpahData.call(
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            nodes = x6Nodes.map(function (node) {
                                                ...
                                                var size = node.size();
                                                var model = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ id: node.id }, data), position), size);
                                                if (includeAttrs) {
                                            ...
                                            edges = x6Edges.map(function (edge) {
                                                ...
                                                var model = (0, tslib_1.__assign)({ id: edge.id }, data);
                                                if (includeAttrs) {
    ...
    GraphSaveDataCommand = (0, tslib_1.__decorate)([
