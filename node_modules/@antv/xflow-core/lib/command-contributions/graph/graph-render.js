...
var GraphRenderCommand = /** @class */ (function () {
    ...
    function GraphRenderCommand() {
        var _this = this;
        this.execute = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.graphRender.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        ...
        this.undo = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                this.ctx.undo();
                return [2 /*return*/, this];
            });
        }); };
        this.redo = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        this.doLoadGraph = function (x6Graph, graphData, isNodeEqual, isEdgeEqual) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var commandService, _a, addNodeConfigs, addEdgeConfigs, 
            // retainNodes,
            // retainEdges,
            removeNodes, removeEdges, updateNodes, updateEdges, _i, addNodeConfigs_1, nodeConfig, _b, addEdgeConfigs_1, edgeConfig, _c, removeNodes_1, removeNode, nodeData, _d, removeEdges_1, removeEdge, edgeData, _e, updateNodes_1, updateNode, nodeData, _f, updateEdges_1, updateEdge, edgeData;
            var _this = this;
            return (0, tslib_1.__generator)(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        _i = 0, addNodeConfigs_1 = addNodeConfigs;
                        _g.label = 1;
                    case 1:
                        if (!(_i < addNodeConfigs_1.length)) return [3 /*break*/, 4];
                        nodeConfig = addNodeConfigs_1[_i];
                        return [4 /*yield*/, commandService.executeCommand(constant_1.XFlowNodeCommands.ADD_NODE.id, {
                                nodeConfig: nodeConfig,
                            }, {
                                name: 'remove servcie',
                                handler: function (args) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                    return (0, tslib_1.__generator)(this, function (_a) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, commandService.executeCommand(constant_1.XFlowGroupCommands.INIT_GROUP.id, {
                            graphData: { nodes: addNodeConfigs, edges: [] },
                        })];
                    case 5:
                        _g.sent();
                        _b = 0, addEdgeConfigs_1 = addEdgeConfigs;
                        _g.label = 6;
                    case 6:
                        if (!(_b < addEdgeConfigs_1.length)) return [3 /*break*/, 9];
                        edgeConfig = addEdgeConfigs_1[_b];
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 6];
                    case 9:
                        _c = 0, removeNodes_1 = removeNodes;
                        _g.label = 10;
                    case 10:
                        if (!(_c < removeNodes_1.length)) return [3 /*break*/, 15];
                        removeNode = removeNodes_1[_c];
                        nodeData = removeNode === null || removeNode === void 0 ? void 0 : removeNode.getData();
                        if (!nodeData.isGroup) return [3 /*break*/, 12];
                    ...
                    case 11:
                        _g.sent();
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, commandService.executeCommand(constant_1.XFlowNodeCommands.DEL_NODE.id, { nodeConfig: nodeData })];
                    case 13:
                        _g.sent();
                        _g.label = 14;
                    case 14:
                        ...
                        return [3 /*break*/, 10];
                    case 15:
                        _d = 0, removeEdges_1 = removeEdges;
                        _g.label = 16;
                    case 16:
                        if (!(_d < removeEdges_1.length)) return [3 /*break*/, 19];
                        removeEdge = removeEdges_1[_d];
                    ...
                    case 18:
                        ...
                        return [3 /*break*/, 16];
                    case 19:
                        _e = 0, updateNodes_1 = updateNodes;
                        _g.label = 20;
                    case 20:
                        if (!(_e < updateNodes_1.length)) return [3 /*break*/, 23];
                        updateNode = updateNodes_1[_e];
                    ...
                    case 22:
                        ...
                        return [3 /*break*/, 20];
                    case 23:
                        _f = 0, updateEdges_1 = updateEdges;
                        _g.label = 24;
                    case 24:
                        if (!(_f < updateEdges_1.length)) return [3 /*break*/, 27];
                        updateEdge = updateEdges_1[_f];
    ...
    GraphRenderCommand = (0, tslib_1.__decorate)([
