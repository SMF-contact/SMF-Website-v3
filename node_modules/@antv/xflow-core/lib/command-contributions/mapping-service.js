...
var GraphMappingHelper = /** @class */ (function () {
    function GraphMappingHelper() {
        ...
        this.createEdgeBetweenNodes = function (edgeConfig) {
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, edgeConfig), { source: _this.nodeMappingRecord.get(source), target: _this.nodeMappingRecord.get(target), sourcePortId: _this.portMappingRecord.get(sourcePortId), targetPortId: _this.portMappingRecord.get(targetPortId) });
        };
        // 更新GroupNode的NodeId
        this.buildGroupRelations = function (groupNode) {
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupNode), { groupChildren: newGroupChildren });
        };
    }
    GraphMappingHelper = (0, tslib_1.__decorate)([
