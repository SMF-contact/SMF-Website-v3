...
var UpdateNodeCommand = /** @class */ (function () {
    ...
    function UpdateNodeCommand() {
        ...
        this.setNodeConfig = function (x6Node, nodeConfig, options) {
            ...
            if (Array.isArray(nodeConfig.ports)) {
                x6Node.setPropByPath('ports/items', nodeConfig.ports, (0, tslib_1.__assign)({ rewrite: true }, options));
            }
        };
        ...
        this.getNextNodeConfig = function (handlerArgs, x6Node) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var nodeData;
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.updateNode.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    UpdateNodeCommand = (0, tslib_1.__decorate)([
