...
var UpdateNodePort = /** @class */ (function () {
    ...
    function UpdateNodePort() {
        ...
        this.getNodeConfig = function (x6Node) {
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, data), position), size);
        };
        this.updatePortsOfNodeConfig = function (cell, ports, options) {
            ...
            if (_this.isNodeAnchors(nodeConfig.ports)) {
                nodeConfig.ports = (0, tslib_1.__spreadArray)([], ports, true);
            }
            if (_this.isPortMetaData(nodeConfig.ports)) {
                nodeConfig.ports.items = (0, tslib_1.__spreadArray)([], ports, true);
            }
        ...
        this.execute = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        graph = _b.sent();
                        return [4 /*yield*/, hooks.updateNodePort.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                ...
                                return (0, tslib_1.__generator)(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, updatePorts((0, tslib_1.__spreadArray)([], currentPorts, true), cell, graph)];
                                        case 1:
                                            nextPorts = _a.sent();
                                            if (nextPorts === false) {
                                                return [2 /*return*/, { err: 'service rejected' }];
                                            }
                                            cell.setPropByPath('ports/items', nextPorts, (0, tslib_1.__assign)({ rewrite: true }, options));
                                            /** update nodeConfig */
                                            this.updatePortsOfNodeConfig(cell, nextPorts, options);
                                            /** add undo */
                                            ctx.addUndo(disposable_1.Disposable.create(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                                var _this = this;
                                                return (0, tslib_1.__generator)(this, function (_a) {
                                                    commandService.executeCommand(constant_1.XFlowNodeCommands.UPDATE_NODE_PORT.id, { node: node, updatePorts: function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () { return (0, tslib_1.__generator)(this, function (_a) {
    ...
    UpdateNodePort = (0, tslib_1.__decorate)([
