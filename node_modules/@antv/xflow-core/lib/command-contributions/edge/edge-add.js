...
var AddEdgeCommand = /** @class */ (function () {
    ...
    function AddEdgeCommand() {
        var _this = this;
        /** 处理edgeConfig的兜底逻辑 */
        this.processEdgeConfig = function (args, edge) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.addEdge.call(
                            ...
                            args, 
                            /** 执行 callback */
                            function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                ...
                                return (0, tslib_1.__generator)(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 5:
                                            ...
                                            return [3 /*break*/, 7];
                                        case 6:
                                            edgeCell = graph.addEdge((0, tslib_1.__assign)((0, tslib_1.__assign)({}, edgeConfig), { 
                                                /** 由于X6的实现是React节点挂在label上的, 所以必须要给label设置值 */
                                                label: (edgeConfig === null || edgeConfig === void 0 ? void 0 : edgeConfig.label) || edgeConfig, data: (0, tslib_1.__assign)({}, edgeConfig) }), eventOptions);
                                            _a.label = 7;
                                        case 7:
    ...
    AddEdgeCommand = (0, tslib_1.__decorate)([
