...
var AddGroupCommand = /** @class */ (function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        hooks = ctx.getHooks();
                        return [4 /*yield*/, hooks.addGroup.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                        ...
                                        case 2:
                                            ...
                                            if (groupChildren.length) {
                                                groupChildren.forEach(function (nodeId) {
                                                    ...
                                                    if (child) {
                                                        child.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, child.getData()), { group: groupId, isCollapsed: false }));
                                                ...
                                                groupCell.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupCell.getData()), { width: groupBBox.width, height: groupBBox.height, groupChildrenSize: { width: groupBBox.width, height: groupBBox.height }, x: groupBBox.x, y: groupBBox.y, isGroup: true }));
    ...
    AddGroupCommand = (0, tslib_1.__decorate)([
