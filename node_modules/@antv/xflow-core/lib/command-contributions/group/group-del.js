...
var DelGroupCommand = /** @class */ (function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        hooks = ctx.getHooks();
                        return [4 /*yield*/, hooks.delGroup.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                        ...
                                        case 5:
                                            ...
                                            if (childrens) {
                                                childrens.forEach(function (child) {
                                                    node.unembed(child);
                                                    child.prop('group', '');
                                                    child.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, child.getData()), { group: '' }));
                                                });
                                            }
    ...
    DelGroupCommand = (0, tslib_1.__decorate)([
