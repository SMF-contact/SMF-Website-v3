...
var CollapseGroupCommand = /** @class */ (function () {
        ...
        this.toggleCollapse = function (groupNode, graph, args) {
            ...
            if (childrens) {
                childrens.forEach(function (item) {
                    ...
                    if (isCollapsed) {
                        _this.toggleVisible((0, tslib_1.__spreadArray)([item], innerEdges, true), false, graph);
                        ...
                        _this.toggleVisible((0, tslib_1.__spreadArray)([item], innerEdges, true), true, graph);
            ...
            groupNode.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupNode.getData()), { isCollapsed: isCollapsed }));
        };
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.collapseGroup.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 3:
                                            if (node) {
                                                ...
                                                this.ctx.addUndo(disposable_1.Disposable.create(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                                    return (0, tslib_1.__generator)(this, function (_a) {
                                                        if (node) {
    ...
    CollapseGroupCommand = (0, tslib_1.__decorate)([
