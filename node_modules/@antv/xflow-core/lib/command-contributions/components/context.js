...
var useIsNodeSelected = function () {
    ...
    react_1.default.useEffect(function () {
        var handler = function (_a) {
            ...
            if (isAdded) {
                cell.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, cell.getData()), { isNodeSelected: true }));
                setIsSelected(true);
                return;
            }
            ...
            if (isRemoved) {
                cell.setData((0, tslib_1.__assign)((0, tslib_1.__assign)({}, cell.getData()), { isNodeSelected: false }));
                setIsSelected(false);
                return;
            }
        };
