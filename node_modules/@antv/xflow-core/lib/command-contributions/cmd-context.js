...
var CmdContext = /** @class */ (function () {
    function CmdContext() {
        ...
        this.runtimeHooks = [];
        /** 获取 x6 实例 */
        this.getX6Graph = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var graphInstance;
        ...
        /** 获取 graph */
        this.getGraphConfig = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                return [2 /*return*/, this.graphProvider.getGraphOptions()];
            });
        }); };
        /** 获取 graphMeta */
        this.getGraphMeta = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var service, meta, _a;
        ...
        this.getArgs = function () {
            /** 注入graph meta */
            var args = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this.args), { modelService: _this.getModelService(), commandService: _this.getCommands(), getGraphMeta: _this.getGraphMeta, getX6Graph: _this.getX6Graph, getGraphConfig: _this.getGraphConfig });
    ...
    CmdContext = (0, tslib_1.__decorate)([
