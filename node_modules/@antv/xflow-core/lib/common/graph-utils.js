...
var node2Json = function (cell) {
    ...
    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, data), { id: cell.id, width: size.width, height: size.height, x: position.x, y: position.y, group: groupId, groupChildren: children ? children.map(function (child) { return child.id; }) : null, groupCollapsedSize: groupCollapsedSize });
};
exports.node2Json = node2Json;
var edge2Json = function (cell) {
    var data = cell.getData() || {};
    return (0, tslib_1.__assign)({ id: cell.id }, data);
};
