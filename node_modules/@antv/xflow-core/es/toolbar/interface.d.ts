 ...
 * vertical：竖直
 */
export declare type IToolbarLayout = 'horizontal' | 'vertical' | 'vertical' | 'horizontal-center';
/**
 * ToolbarGroup的json配置
 * items是id string的集合
 */
...
export declare type IToolbarModel = Simplify<NsModel.IModel<IToolbarOptions>>;
