...
var BloomPass = (_dec = (0, _inversify.injectable)(), _dec(_class = function (_BasePostProcessingPa) {
  (0, _inherits2.default)(BloomPass, _BasePostProcessingPa);

  var _super = _createSuper(BloomPass);

  function BloomPass() {
    (0, _classCallCheck2.default)(this, BloomPass);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(BloomPass, [{
    key: "setupShaders",
    ...
    value: function convertOptionsToUniforms(options) {
      ...
      if (!(0, _isNil2.default)(options.bloomRadius)) {
        uniforms.u_radius = options.bloomRadius;
      }

      if (!(0, _isNil2.default)(options.bloomIntensity)) {
        uniforms.u_intensity = options.bloomIntensity;
      }

      if (!(0, _isNil2.default)(options.bloomBaseRadio)) {
