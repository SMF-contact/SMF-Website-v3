...
var BasePostProcessingPass = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IShaderModuleService), _dec(_class = (_class2 = function () {
  ...
  (0, _createClass2.default)(BasePostProcessingPass, [{
    ...
    value: function convertOptionsToUniforms(options) {
      ...
      Object.keys(options).forEach(function (optionName) {
        if (!(0, _isNil2.default)(options[optionName])) {
          uniforms["u_".concat((0, _upperFirst2.default)((0, _camelCase2.default)(optionName)))] = options[optionName];
        }
      });
      return uniforms;
    }
