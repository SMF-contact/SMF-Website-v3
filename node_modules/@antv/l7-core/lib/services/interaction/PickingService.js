...
var PickingService = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IRendererService), _dec3 = (0, _inversify.inject)(_types.TYPES.IGlobalConfigService), _dec4 = (0, _inversify.inject)(_types.TYPES.IInteractionService), _dec5 = (0, _inversify.inject)(_types.TYPES.ILayerService), _dec(_class = (_class2 = function () {
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!(this.alreadyInPicking || this.layerService.alreadyInRendering || this.layerService.isMapDragging() || !this.layerService.getShaderPickStat())) {
                  _context2.next = 2;
                  break;
                }
