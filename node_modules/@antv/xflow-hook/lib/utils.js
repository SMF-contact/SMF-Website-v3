...
var toposort_1 = (0, tslib_1.__importDefault)(require("toposort"));
var ErrorUtils;
(function (ErrorUtils) {
    var ErrorEnum;
    (function (ErrorEnum) {
    ...
    var HookError = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(HookError, _super);
    ...
    var createError = function (code, message) {
        ...
        return new (HookError.bind.apply(HookError, (0, tslib_1.__spreadArray)([void 0, code, message], args, false)))();
    };
...
(function (HookUtils) {
    ...
    HookUtils.normalize = function (hookConfig, hookMap) {
        ...
        return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], innerHooks, true), runtimeHook, true).filter(function (item) { return item && !!item.handler; });
    };
    /** 排序 hooks */
