...
describe('test HookHub class', function () {
    ...
    test('HookHub can register hooks and dispose', function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    test('HookHub can sort hooks by using before after ', function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        var hooks, hookMeta, disposable, innerHooks, _a;
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    test('HookHub can call hooks ', function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    hookMeta = {
                        name: 'count_add_one',
                        handler: function (args) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                            return (0, tslib_1.__generator)(this, function (_a) {
                    ...
                    return [4 /*yield*/, hooks.call({ count: 0 }, function (args) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                            var count;
                            return (0, tslib_1.__generator)(this, function (_a) {
                                count = args.count;
                                return [2 /*return*/, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, args), { count: count * 10 + '' })];
                            });
                        }); })];
                case 1:
                    count10 = _a.sent();
    ...
    test('HookHub hooks can use return null to skip main handler', function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    hooks.registerHook(hookMeta);
                    mainHandler = jest.fn(function (_x) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                        return (0, tslib_1.__generator)(this, function (_a) {
                    ...
                    firstHookHandler = jest.fn(function (args) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                        return (0, tslib_1.__generator)(this, function (_a) {
                    ...
                    secondHookHandler = jest.fn(function (_args, _handler) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                        return (0, tslib_1.__generator)(this, function (_a) {
                            console.log('it will stop here');
                            return [2 /*return*/, null];
                        });
                    }); });
                    thirdHookHandler = jest.fn(function (_args) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                        return (0, tslib_1.__generator)(this, function (_a) {
    ...
    test('HookHub hooks can wrap main handler', function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    secondHookHandler = jest.fn(function (_args, handler) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                        var newHandler;
                        return (0, tslib_1.__generator)(this, function (_a) {
