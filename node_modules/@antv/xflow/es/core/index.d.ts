 ...
 * 3. Graph：XFlowCanvas
 *****************************************************/
export { XFlow, XFlowCanvas, XFlowAppExtensionMoudle, XFlowAppProvider, XFlowAppContext, useXFlowApp, useXflowPrefixCls, XFlowConfigProviderContext, ExtensionRegistryContext, useExtensionRegistry, } from '@antv/xflow-core';
/** widget：extension  */
 ...
 *  XFlow Hooks： 钩子函数
 *****************************************************/
export { IHookService, IRegsiterHookFn, IRegisterHookHubFn, IHookContribution, IEvent, IHooks, createHookConfig, } from '@antv/xflow-core';
/*******************************************************
 *  Model Service：全局状态
 *****************************************************/
