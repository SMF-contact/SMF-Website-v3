...
var classnames_2 = (0, tslib_1.__importDefault)(require("classnames"));
/** render toolbar */
...
var InnerRender = function (props) {
    ...
    // loading
    if (!isModelReady) {
        return (react_1.default.createElement("div", { className: containerClz, style: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, positionStyle), props.style) },
            react_1.default.createElement(antd_1.Spin, { spinning: true, size: "small" })));
    }
    // render custom component
    if (customRender) {
        return (react_1.default.createElement("div", { className: containerClz, style: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, positionStyle), props.style) }, react_1.default.createElement(customRender, { config: state })));
    }
    // render toolbars
    return (react_1.default.createElement("div", { className: containerClz, style: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, positionStyle), props.style) },
