...
var ToolbarItem = function (props) {
    ...
    if (ToolbarItemWrap) {
        return (react_1.default.createElement(ToolbarItemWrap, (0, tslib_1.__assign)({}, item, { onClick: onItemClick }),
            react_1.default.createElement(x6_react_components_1.Toolbar.Item, (0, tslib_1.__assign)({}, item, { icon: icon, text: text, className: clz, disabled: !isEnabled, tooltip: item.tooltip || item.text, tooltipProps: (0, tslib_1.__assign)({ placement: layout === 'vertical' ? 'left' : 'bottom' }, item.tooltipProps), onClick: function () { } }))));
    }
    return (react_1.default.createElement(x6_react_components_1.Toolbar.Item, (0, tslib_1.__assign)({}, item, { icon: icon, text: text, className: clz, hidden: !item, disabled: !isEnabled, tooltip: item.tooltip || item.text, onClick: onItemClick, tooltipProps: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, item.tooltipProps), { placement: layout === 'vertical' ? 'left' : 'bottom' }) })));
};
