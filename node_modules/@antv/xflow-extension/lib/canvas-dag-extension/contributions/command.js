...
(function (NsGraphStatusCommand) {
    ...
    NsGraphStatusCommand.statusDiff = function (cur, next) {
        var items = new Set((0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], cur, true), next, true));
    ...
    NsGraphStatusCommand.shouldStop = function (info) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
...
var QueryGraphStatusCommand = /** @class */ (function () {
    function QueryGraphStatusCommand() {
        ...
        /** 获取Model */
        this.getStatusModel = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        ...
        /** 更新Model数据 */
        this.updateModelValue = function (callback) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var statusModel;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
        ...
        /** 停止Looping的flag */
        this.stopCurrentStatusLooping = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        ...
        /** 设置停止looping的方法 */
        this.addStopDispose = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var statusModel, subscription;
            var _this = this;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
        ...
        this.updateNodeData = function (id, data) {
            ...
            cell.setData((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, cell.getData()), cell.getSize()), cell.getPosition()), data));
        };
        /** 更新连线数据 */
            ...
            return (0, tslib_1.__generator)(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        // 引用
                        _b.x6Graph = _c.sent();
                        return [4 /*yield*/, hooks.queryGraphStatus.call(args, function (handlerArgs) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    QueryGraphStatusCommand = (0, tslib_1.__decorate)([
