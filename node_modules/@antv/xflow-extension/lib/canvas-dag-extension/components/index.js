...
var DagGraphExtension = function (props) {
    ...
    var config = react_1.default.useMemo(function () { return ({
        ...
        getConfig: function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () { return (0, tslib_1.__generator)(this, function (_a) {
            return [2 /*return*/, props];
        }); }); },
    }); }, [props]);
    return react_1.default.createElement(xflow_core_1.XFlowAppExtensionMoudle, { config: config, createModule: module_1.createDagExtensionModule });
};
