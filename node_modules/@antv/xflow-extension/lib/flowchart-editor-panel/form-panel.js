...
var FlowchartFormPanel = function (props) {
    ...
    var _b = props.controlMapService, controlMapService = _b === void 0 ? control_map_service_1.defaultControlMapService : _b, _c = props.formSchemaService, formSchemaService = _c === void 0 ? form_schema_service_1.defaultFormSchemaService : _c, _d = props.position, position = _d === void 0 ? { width: 240, top: 0, bottom: 0, right: 0 } : _d, _e = props.show, show = _e === void 0 ? true : _e, rest = (0, tslib_1.__rest)(props, ["controlMapService", "formSchemaService", "position", "show"]);
    if (!show) {
        return null;
    }
    var _f = position.width, width = _f === void 0 ? 200 : _f, right = position.right;
    return (react_1.default.createElement(base_panel_1.WorkspacePanel, { className: exports.CONTAINER_CLASS, position: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, position), { right: !collpased ? right : -width }) },
        react_1.default.createElement("div", { className: "".concat(exports.CONTAINER_CLASS, "-wrapper") },
            react_1.default.createElement(canvas_json_schema_form_1.JsonSchemaForm, (0, tslib_1.__assign)({ targetType: ['node', 'edge', 'canvas', 'group'], controlMapService: controlMapService, formSchemaService: formSchemaService, position: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, position), { top: 0 }), prefixClz: "xflow-form-editor" }, rest)),
