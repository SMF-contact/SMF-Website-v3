...
var useAsync_1 = (0, tslib_1.__importDefault)(require("./useAsync"));
var FlowchartFormWrapper = function (props) {
    ...
    var getSelectNode = (0, react_1.useCallback)(function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        var data;
    ...
    var getSelectEdge = (0, react_1.useCallback)(function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        var cell, data;
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    cell = _a.sent();
                    data = cell.getData();
                    return [2 /*return*/, (0, tslib_1.__assign)({ id: cell.id }, data)];
            }
        });
    }); }, [modelService]);
    ...
    react_1.default.useEffect(function () {
        commandService.executeCommand(xflow_core_1.XFlowGraphCommands.SAVE_GRAPH_DATA.id, {
            saveGraphDataService: function (meta, graph) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                return (0, tslib_1.__generator)(this, function (_a) {
    ...
    var updateNode = function (value) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    nodeConfig = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentNodeData), value);
            ...
            return (0, tslib_1.__generator)(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        edgeConfig = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentEdgeData), (key ? value[key] : value)), { attrs: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentEdgeData.attrs), (_a = {}, _a[type] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (_b = currentEdgeData.attrs) === null || _b === void 0 ? void 0 : _b[type]), (key ? value[key] : value)), _a)) });
    ...
    var updateGroup = function (value) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    nodeConfig = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, currentGroupData), value);
                    return [4 /*yield*/, commandService.executeCommand(xflow_core_1.XFlowNodeCommands.UPDATE_NODE.id, {
                            nodeConfig: nodeConfig,
                        })];
                case 2:
    ...
    return (react_1.default.createElement(canvas_json_schema_form_1.FormItemWrapper, { schema: controlSchema }, function () {
        return children((0, tslib_1.__assign)({}, data), { updateNode: updateNode, updateEdge: updateEdge, updateGroup: updateGroup });
    }));
};
