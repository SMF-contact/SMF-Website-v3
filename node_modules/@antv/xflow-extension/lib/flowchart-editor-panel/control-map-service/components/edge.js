...
var EdgeComponent = function (props) {
    ...
    var _b = (0, react_1.useState)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, constants_1.DefaultEdgeConfig), config)), edgeConfig = _b[0], setEdgeConfig = _b[1];
    (0, react_1.useEffect)(function () {
        setEdgeConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, constants_1.DefaultEdgeConfig), config));
    }, [config]);
    ...
    var onEdgeConfigChange = function (key, value, type) {
        ...
        /** 全量更新，简化逻辑 */
        if (key === 'arrow') {
            setEdgeConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, edgeConfig), { attrs: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, edgeConfig.attrs), (_a = {}, _a[type] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (_f = edgeConfig.attrs) === null || _f === void 0 ? void 0 : _f[type]), value), _a)) }));
        }
        else {
            setEdgeConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, edgeConfig), (_b = {}, _b[key] = value, _b.attrs = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, edgeConfig.attrs), (_c = {}, _c[type] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (_g = edgeConfig.attrs) === null || _g === void 0 ? void 0 : _g[type]), (_d = {}, _d[key] = value, _d)), _c)), _b)));
        }
        updateEdge((_e = {},
            _e[key] = value,
...
var EdgeService = function (props) {
    return (react_1.default.createElement(form_wrapper_1.FlowchartFormWrapper, (0, tslib_1.__assign)({}, props, { type: "edge" }), function (config, plugin) { return react_1.default.createElement(EdgeComponent, (0, tslib_1.__assign)({}, props, { plugin: plugin, config: config })); }));
};
