...
var GroupComponent = function (props) {
    ...
    var _b = (0, react_1.useState)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, flowchart_node_panel_1.DefaultNodeConfig), config)), groupConfig = _b[0], setGroupConfig = _b[1];
    var onGroupConfigChange = function (key, value) {
        var _a, _b;
        setGroupConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, groupConfig), (_a = {}, _a[key] = value, _a)));
        updateGroup((_b = {},
            _b[key] = value,
            _b));
    };
    (0, react_1.useEffect)(function () {
        setGroupConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, flowchart_node_panel_1.DefaultNodeConfig), config));
    }, [config]);
...
var GroupService = function (props) {
    return (react_1.default.createElement(form_wrapper_1.FlowchartFormWrapper, (0, tslib_1.__assign)({}, props), function (config, plugin) { return react_1.default.createElement(GroupComponent, (0, tslib_1.__assign)({}, props, { plugin: plugin, config: config })); }));
};
