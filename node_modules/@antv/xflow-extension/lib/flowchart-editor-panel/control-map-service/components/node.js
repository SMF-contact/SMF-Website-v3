...
var NodeComponent = function (props) {
    ...
    var _b = (0, react_1.useState)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, flowchart_node_panel_1.DefaultNodeConfig), config)), nodeConfig = _b[0], setNodeConfig = _b[1];
    var onNodeConfigChange = function (key, value) {
        var _a, _b;
        setNodeConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, nodeConfig), (_a = {}, _a[key] = value, _a)));
        updateNode((_b = {},
            _b[key] = value,
            _b));
    };
    (0, react_1.useEffect)(function () {
        setNodeConfig((0, tslib_1.__assign)((0, tslib_1.__assign)({}, flowchart_node_panel_1.DefaultNodeConfig), config));
    }, [config]);
...
var NodeService = function (props) {
    return (react_1.default.createElement(form_wrapper_1.FlowchartFormWrapper, (0, tslib_1.__assign)({}, props), function (config, plugin) { return react_1.default.createElement(NodeComponent, (0, tslib_1.__assign)({}, props, { plugin: plugin, config: config })); }));
};
