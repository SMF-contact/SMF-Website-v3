...
var setProps = function (props) {
    exports.globalProps.config = props;
};
...
var setInstance = function (app) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    var x6graph;
...
var getGraphData = function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    var app;
    return (0, tslib_1.__generator)(this, function (_a) {
...
exports.onConfigChange = (0, lodash_1.debounce)(function (config) {
    ...
    return configChange((0, tslib_1.__assign)({ data: (0, exports.getGraphData)() }, config));
}, 300, {
    trailing: true,
});
