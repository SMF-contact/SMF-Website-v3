...
exports.useGraphConfig = (0, xflow_core_1.createGraphConfig)(function (config, proxy) {
    var _a = proxy.getValue(), _b = _a.config, canvasConfig = _b === void 0 ? {} : _b, useConfig = _a.useConfig;
    ...
    /** 这里比较黑，props 共享*/
    (0, utils_1.setProps)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, proxy.getValue()), { graphConfig: config }));
