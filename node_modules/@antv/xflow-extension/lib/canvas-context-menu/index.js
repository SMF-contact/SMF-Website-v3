...
var CanvasContextMenu = function (props) {
    ...
    return (react_1.default.createElement(xflow_core_1.XFlowAppExtensionMoudle, { createModule: module_1.createModule, config: contextMenuConfig }, canRender && react_1.default.createElement(components_1.ContextMenuRender, { config: contextMenuConfig })));
};
