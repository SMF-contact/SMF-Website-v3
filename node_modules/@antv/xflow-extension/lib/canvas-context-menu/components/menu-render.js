...
var renderMenuOptions = function (props) {
    ...
    return (react_1.default.createElement(x6_react_components_1.Menu.Item, { key: String(id), text: label, disabled: !isEnabled, icon: Icon ? react_1.default.createElement(Icon, null) : null, active: active, hotkey: hotkey, onClick: function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
