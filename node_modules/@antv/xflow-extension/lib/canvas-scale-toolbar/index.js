...
var CanvasScaleToolbar = function (props) {
    ...
    return (react_1.default.createElement(canvas_toolbar_1.CanvasToolbar, (0, tslib_1.__assign)({ layout: "vertical" }, props, { config: config, position: props.position || { top: 12, right: 12 } })));
};
