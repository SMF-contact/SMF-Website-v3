...
var PanelFooter = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "".concat(props.prefixClz, "-footer"), style: props.style },
            isValidFooterFC &&
                react_1.default.createElement(panelProps.footer, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { headerStyle: {}, bodyStyle: {}, footerStyle: props.style, targetData: state.targetData, targetType: state.targetType, modelService: app.modelService, commandService: app.commandService })),
