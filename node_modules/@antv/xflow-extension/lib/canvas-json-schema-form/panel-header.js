...
var PanelHeader = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "".concat(prefixClz, "-header"), style: props.style },
            isValidHeaderFC &&
                react_1.default.createElement(panelProps.header, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { headerStyle: props.style, bodyStyle: {}, footerStyle: {}, targetData: state.targetData, targetType: state.targetType, modelService: app.modelService, commandService: app.commandService })),
