...
var JsonSchemaFormMain = function (props) {
    ...
    // 在fields change时的回调
    var onFieldsChange = react_1.default.useCallback(function (changedFields, allFields) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        var result;
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
    ...
    if (getCustomRenderComponent) {
        ...
        if (Component) {
            return react_1.default.createElement(Component, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { headerStyle: headerStyle, bodyStyle: bodyStyle, footerStyle: footerStyle, targetData: state.targetData, targetType: state.targetType, modelService: modelService, commandService: commandService }));
        }
    }
    return (react_1.default.createElement("div", { className: prefixClz },
        react_1.default.createElement(panel_header_1.PanelHeader, (0, tslib_1.__assign)({ hasSchema: !noSchema }, props, { state: state, style: headerStyle, prefixClz: props.prefixClz })),
        react_1.default.createElement(panel_body_1.PanelBody, (0, tslib_1.__assign)({}, props, { key: state.targetData && state.targetData.id, style: bodyStyle, prefixClz: props.prefixClz, loading: state.loading, schema: state.schema, triggerUpdate: triggerUpdate, onFieldsChange: onFieldsChange })),
        react_1.default.createElement(panel_footer_1.PanelFooter, (0, tslib_1.__assign)({}, props, { state: state, style: footerStyle }))));
};
...
var JsonSchemaForm = function (props) {
    ...
    return (react_1.default.createElement(base_panel_1.WorkspacePanel, (0, tslib_1.__assign)({}, props, { className: prefixClz }),
        react_1.default.createElement(exports.JsonSchemaFormMain, (0, tslib_1.__assign)({}, props, { prefixClz: prefixClz }))));
};
