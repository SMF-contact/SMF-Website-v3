...
var SchemaForm = function (props) {
    var _a;
    var _b;
    var schema = props.schema, formInstance = props.form, className = props.className, triggerUpdate = props.triggerUpdate, defaultControlRender = props.defaultControlRender, afterUpdatingCb = props.afterUpdatingCb, controlMapfromParent = props.controlMap, otherProps = (0, tslib_1.__rest)(props, ["schema", "form", "className", "triggerUpdate", "defaultControlRender", "afterUpdatingCb", "controlMap"]);
    ...
    return (react_1.default.createElement(antd_1.Form, (0, tslib_1.__assign)({ size: "small", form: form, layout: "vertical", className: (0, classnames_1.default)('xflow-json-form', className) }, otherProps),
