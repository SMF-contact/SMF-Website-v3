...
var Tooltip = function (props) {
    var text = props.text, otherProps = (0, tslib_1.__rest)(props, ["text"]);
    if (!text) {
        return null;
    }
    return (react_1.default.createElement(antd_1.Tooltip, (0, tslib_1.__assign)({ placement: "left", title: text }, otherProps),
