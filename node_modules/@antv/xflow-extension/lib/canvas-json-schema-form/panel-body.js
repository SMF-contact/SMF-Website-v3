...
var PanelBody = function (props) {
    ...
    var controlMapCache = react_1.default.useMemo(function () {
        var controlMap = (0, index_1.makeControlMap)((0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], index_1.xflowDefaultControls, true), defaultControls, true));
    ...
    if (loading) {
        return (react_1.default.createElement("div", { className: "".concat(props.prefixClz, "-body"), style: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props.style), { display: 'flex', justifyContent: 'center', alignItems: 'center' }) },
