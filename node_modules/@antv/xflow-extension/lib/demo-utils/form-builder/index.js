...
function FormBuilder(props) {
    ...
    return (react_1.default.createElement(antd_1.Form, { size: "small", form: form, style: style, layout: layout, onFinish: onFinish, className: className, initialValues: initialValues, labelCol: layout === 'vertical' ? { span: 24 } : { span: 8 }, wrapperCol: layout === 'vertical' ? { span: 24 } : { span: 16 } },
        formItems.map(function (item) { return (react_1.default.createElement(antd_1.Form.Item, (0, tslib_1.__assign)({ label: item.label, name: item.name, rules: item.rules }, item.itemProps), react_1.default.createElement(item.render, item.renderProps))); }),
        react_1.default.createElement(antd_1.Form.Item, { wrapperCol: { offset: 0, span: 24 } }, submitButton ? (submitButton) : (react_1.default.createElement(antd_1.Button, (0, tslib_1.__assign)({ type: "primary", htmlType: "submit", style: { width: '100%' } }, buttonProps), "\u6267\u884C\u547D\u4EE4")))));
}
