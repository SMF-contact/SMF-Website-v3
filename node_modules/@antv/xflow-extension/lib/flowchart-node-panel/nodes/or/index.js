...
var OrNode = function (props) {
    ...
    var path1 = [
        ['M', height / 2, constants_1.NODE_PADDING],
        ['L', height / 2, height - 2 * constants_1.NODE_PADDING], // bottom-center
    ];
    var path2 = [
        ['M', constants_1.NODE_PADDING, height / 2],
        ['L', height - 2 * constants_1.NODE_PADDING, height / 2], // right-center
    ];
