...
var Source = function (_EventEmitter) {
  ...
  function Source(data, cfg) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "parser", {
      type: 'geojson'
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "transforms", []);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "cluster", false);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "clusterOptions", {
      enable: false,
      radius: 40,
      maxZoom: 20,
      zoom: -99,
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "invalidExtent", false);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "originData", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "rawData", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "cfg", {});
  ...
  (0, _createClass2.default)(Source, [{
    ...
    value: function updateClusterData(zoom) {
      ...
      this.data = (0, _factory.getParser)('geojson')({
    ...
    value: function caculClusterExtent(bufferRatio) {
      ...
      if (!this.invalidExtent) {
        newBounds = (0, _l7Utils.padBounds)((0, _l7Utils.bBoxToBounds)(this.extent), bufferRatio);
      }
    ...
    value: function excuteParser() {
      ...
      var sourceParser = (0, _factory.getParser)(type);
    ...
    value: function executeTrans() {
      ...
      trans.forEach(function (tran) {
        var type = tran.type;
        var data = (0, _factory.getTransform)(type)(_this3.data, tran);
