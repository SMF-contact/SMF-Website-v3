...
var Annotation = /** @class */ (function (_super) {
    ...
    Annotation.prototype.getAnnotationCfg = function (type, option, theme) {
        ...
        if (type === 'arc') {
            var _a = option, start_1 = _a.start, end_1 = _a.end, rest = (0, tslib_1.__rest)(_a, ["start", "end"]);
            ...
            var _b = option, start_2 = _b.start, end_2 = _b.end, rest = (0, tslib_1.__rest)(_b, ["start", "end"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { start: sp, end: ep, src: option.src });
        }
        else if (type === 'line') {
            var _c = option, start_3 = _c.start, end_3 = _c.end, rest = (0, tslib_1.__rest)(_c, ["start", "end"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { start: sp, end: ep, text: (0, util_1.get)(option, 'text', null) });
        }
        else if (type === 'region') {
            var _d = option, start_4 = _d.start, end_4 = _d.end, rest = (0, tslib_1.__rest)(_d, ["start", "end"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { start: sp, end: ep });
        }
        else if (type === 'text') {
            var filteredData = this.view.getData();
            var _e = option, position_1 = _e.position, content = _e.content, rest = (0, tslib_1.__rest)(_e, ["position", "content"]);
            var textContent = content;
            if ((0, util_1.isFunction)(content)) {
                textContent = content(filteredData);
            }
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, textPoint), rest), { content: textContent });
        }
        else if (type === 'dataMarker') {
            var _f = option, position_2 = _f.position, point = _f.point, line = _f.line, text = _f.text, autoAdjust = _f.autoAdjust, direction = _f.direction, rest = (0, tslib_1.__rest)(_f, ["position", "point", "line", "text", "autoAdjust", "direction"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), textPoint), { coordinateBBox: this.getCoordinateBBox(), point: point, line: line, text: text, autoAdjust: autoAdjust, direction: direction });
        }
        else if (type === 'dataRegion') {
            var _g = option, start_5 = _g.start, end_5 = _g.end, region = _g.region, text = _g.text, lineLength = _g.lineLength, rest = (0, tslib_1.__rest)(_g, ["start", "end", "region", "text", "lineLength"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { points: this.getRegionPoints(start_5, end_5), region: region, text: text, lineLength: lineLength });
        }
        else if (type === 'regionFilter') {
            var _h = option, start_6 = _h.start, end_6 = _h.end, apply_1 = _h.apply, color = _h.color, rest = (0, tslib_1.__rest)(_h, ["start", "end", "apply", "color"]);
            ...
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { color: color, shapes: shapes_1, start: sp, end: ep });
        }
        else if (type === 'shape') {
            ...
            var _k = option, html_1 = _k.html, position_3 = _k.position, restOptions = (0, tslib_1.__rest)(_k, ["html", "position"]);
            ...
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, restOptions), textPoint), { 
                // html 组件需要指定 parent
    ...
    Annotation.prototype.updateOrCreate = function (option) {
        ...
        if (co) {
            ...
            co.component.update((0, tslib_1.__assign)((0, tslib_1.__assign)({}, (cfg || {})), { visible: !!cfg }));
