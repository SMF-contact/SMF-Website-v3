...
// 坐标轴默认动画配置
var AXIS_DEFAULT_ANIMATE_CFG = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, animate_1.DEFAULT_ANIMATE_CFG), { appear: null });
/**
 * @ignore
...
var Axis = /** @class */ (function (_super) {
    ...
    Axis.prototype.getLineAxisCfg = function (scale, axisOption, direction) {
        ...
        var optionWithTitle = (0, util_1.get)(axisOption, ['title'])
            ...
            : axisOption;
        var cfg = (0, util_1.deepMix)((0, tslib_1.__assign)((0, tslib_1.__assign)({ container: container }, region), { ticks: scale.getTicks().map(function (tick) { return ({ id: "".concat(tick.tickValue), name: tick.text, value: tick.value }); }), verticalFactor: coordinate.isPolar
    ...
    Axis.prototype.getCircleAxisCfg = function (scale, axisOption, direction) {
        ...
        var optionWithTitle = (0, util_1.get)(axisOption, ['title'])
            ? (0, util_1.deepMix)({ title: { style: { text: titleText } } }, { title: (0, axis_1.getAxisTitleOptions)(this.view.getTheme(), direction, axisOption.title) }, axisOption)
            : axisOption;
        var cfg = (0, util_1.deepMix)((0, tslib_1.__assign)((0, tslib_1.__assign)({ container: container }, (0, axis_1.getCircleAxisCenterRadius)(this.view.getCoordinate())), { ticks: ticks, verticalFactor: 1, theme: axisThemeCfg }), axisThemeCfg, optionWithTitle);
        var _a = this.getAnimateCfg(cfg), animate = _a.animate, animateOption = _a.animateOption;
        cfg.animate = animate;
        cfg.animateOption = animateOption;
        return cfg;
