 ...
 * 分类列表项接口
 */
export declare type CategoryLegendListItem = {
    /**
     * 唯一值，用于查找
     */
    id?: string;
...
export declare type CategoryLegendCustomContent = (title: string, items: CategoryLegendListItem[]) => string | HTMLElement;
/**
 * 分类 Legend 配置接口
 */
...
export declare type ContinueLegendCustomContent = (title: string, min: number, max: number, colors: string[]) => string | HTMLElement;
/**
 * 连续 Legend 配置接口
 */
