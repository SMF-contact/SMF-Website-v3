...
exports.ContinueLegend = void 0;
var tslib_1 = require("tslib");
var util_1 = require("@antv/util");
var dom_util_1 = require("@antv/dom-util");
var theme_1 = (0, tslib_1.__importDefault)(require("./theme"));
var constants_1 = require("./constants");
var component_1 = require("../../core/component");
var dom_1 = require("../../utils/dom");
var ContinueLegend = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(ContinueLegend, _super);
    ...
    ContinueLegend.prototype.getDefaultOptions = function () {
        return (0, util_1.deepMix)({}, _super.prototype.getDefaultOptions.call(this), {
            ...
            ribbonTpl: constants_1.RIBBON_TPL,
    ...
    ContinueLegend.prototype.cacheDoms = function () {
        ...
        var ribbonContainerDom = container.getElementsByClassName(constants_1.RIBBON_CONTAINER_CLASS)[0];
    ...
    ContinueLegend.prototype.renderRibbon = function () {
        ...
        var _a = this.options, min = _a.min, max = _a.max, colors = _a.colors, _b = _a.ribbonTpl, ribbonTpl = _b === void 0 ? constants_1.RIBBON_TPL : _b;
        ...
        if (ribbonContainerDom) {
            ...
            var domStr = (0, util_1.substitute)(ribbonTpl, substituteObj);
    ...
    ContinueLegend.prototype.clearRibbonContainerDoms = function () {
        if (this.ribbonContainerDom) {
            (0, dom_1.clearDom)(this.ribbonContainerDom);
        }
    };
    /**
     * 清空所有
...
exports.ContinueLegend = ContinueLegend;
