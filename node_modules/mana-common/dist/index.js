...
(function (Event) {
  Event.None = function () {
    return exports.Disposable.NONE;
  };
...
var CancellationTokenSource = /*#__PURE__*/function () {
  ...
  _createClass(CancellationTokenSource, [{
    ...
    value: function cancel() {
      ...
      } else if (this._token !== exports.CancellationToken.Cancelled) {
        this._token.cancel();
      }
    }
  }, {
...
var DisposableCollection = /*#__PURE__*/function () {
  ...
  _createClass(DisposableCollection, [{
    ...
    value: function push(disposable) {
      ...
      var toRemove = exports.Disposable.create(function () {
...
function timeout(ms) {
  var token = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : exports.CancellationToken.None;
