...
exports.useGraphConfig = exports.useGraphHook = exports.NsAddEdgeEvent = void 0;
...
var node_panel_1 = require("../../components/node-panel");
var group_panel_1 = require("../../components/group-panel");
var edge_panel_1 = require("../../components/edge-panel");
...
var XFlowEdge = x6_1.Shape.Edge.registry.register('xflow', x6_1.Shape.Edge.define({
    zIndex: 1,
    highlight: true,
    shape: edge_panel_1.FLOWCHART_EDGE,
    name: 'custom-edge',
    label: '',
    anchor: {
        name: 'midSide',
    ...
    attrs: edge_panel_1.DefaultEdgeConfig,
    data: {
        label: '',
    },
}), true);
exports.useGraphHook = (0, xflow_1.createHookConfig)(function (config, proxy) {
    var flowchartId = proxy.getValue().flowchartId;
    config.setRegisterHook(function (hooks) {
        var todo = new xflow_1.DisposableCollection();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, commandService.executeCommand(xflow_1.XFlowEdgeCommands.ADD_EDGE.id, config)];
                                case 1:
                                    _a.sent();
                                    onAddEdge = (0, util_1.getProps)(flowchartId, 'onAddEdge');
                                    if (typeof onAddEdge === 'function') {
                                        onAddEdge(config);
                                    }
                                    (0, util_1.onConfigChange)({ type: 'add:edge', config: config });
                                    args.edge.remove();
                                    return [2 /*return*/];
                            }
                        });
...
/**  graphConfig hook  */
exports.useGraphConfig = (0, xflow_1.createGraphConfig)(function (config, proxy) {
    ...
    (0, edge_panel_1.registerEdge)(config);
    (0, node_panel_1.setNodeRender)(config, nodePanelProps);
    (0, group_panel_1.setGroupRender)(config);
    config.setX6Config(__assign({ grid: true, history: true, resizing: {
            enabled: true,
            minWidth: node_panel_1.NODE_HEIGHT,
            minHeight: node_panel_1.NODE_HEIGHT,
            preserveAspectRatio: function (shape) {
                var data = shape.data;
                return node_panel_1.ASPECTRATIONODE.includes(data.name);
            },
        }, snapline: {
            enabled: true,
        }, 
    ...
    config.setEvents([
        ...
        },
        {
            ...
            callback: function (e, cmds, ctx) {
                var _a, _b;
                var nodeData = (_a = e === null || e === void 0 ? void 0 : e.node) === null || _a === void 0 ? void 0 : _a.getData();
                (0, events_1.changePortsVisible)(false);
        ...
        },
        {
            ...
            callback: function (e, cmds, ctx) {
                (0, events_1.addTools)(e, cmds, ctx);
            },
        },
        {
            eventName: 'edge:mouseleave',
            callback: function (e, cmds, ctx) {
                (0, events_1.removeTools)(e, cmds, ctx);
            },
        },
        {
            eventName: 'node:mouseenter',
            callback: function (e) {
                (0, events_1.changePortsVisible)(true, e);
            },
        },
        {
            eventName: 'node:mouseleave',
            callback: function (e, cmds, ctx) {
                (0, events_1.changePortsVisible)(false, e);
            },
        },
        {
            eventName: 'node:moved',
            callback: function (e, cmds, ctx) {
                (0, events_1.movedNode)(e, cmds, ctx);
            },
        },
        {
            eventName: 'node:resized',
            callback: function (e, cmds, ctx) {
                (0, events_1.resizeNode)(e, cmds, ctx);
            },
        },
    ]);
});
