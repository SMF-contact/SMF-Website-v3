...
var FormWrapper = function (props) {
    ...
    var _b = (0, xflow_1.usePanelContext)(), commandService = _b.commandService, modelService = _b.modelService;
    var flowchartId = (0, react_1.useContext)(context_1.default).flowchartId;
    var getSelectNode = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
    ...
    var getSelectEdge = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        var cell, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, xflow_1.MODELS.SELECTED_CELL.useValue(modelService)];
                case 1:
                    cell = _a.sent();
                    data = cell.getData();
    ...
    var _c = (0, useAsync_1.default)(type === 'edge' ? getSelectEdge : getSelectNode), data = _c.data, loading = _c.loading;
    react_1.default.useEffect(function () {
        commandService.executeCommand(xflow_1.XFlowGraphCommands.SAVE_GRAPH_DATA.id, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, commandService.executeCommand(xflow_1.XFlowNodeCommands.UPDATE_NODE.id, {
                            nodeConfig: nodeConfig,
                        })];
                case 2:
                    _a.sent();
                    (0, util_1.onConfigChange)({ type: 'update:node', config: nodeConfig }, flowchartId);
                    return [2 /*return*/];
            }
        });
    }); };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, commandService.executeCommand(xflow_1.XFlowEdgeCommands.UPDATE_EDGE.id, { edgeConfig: edgeConfig })];
                    case 2:
                        _c.sent();
                        (0, util_1.onConfigChange)({ type: 'update:edge', config: edgeConfig }, flowchartId);
                        return [2 /*return*/];
                }
            });
        });
    ...
    var updateGroup = function (value) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    (0, util_1.onConfigChange)({ type: 'update:group', config: nodeConfig }, flowchartId);
                    return [2 /*return*/];
            }
        });
    }); };
    ...
    return (react_1.default.createElement(xflow_1.FormItemWrapper, { schema: controlSchema }, function () {
