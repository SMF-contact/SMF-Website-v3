...
exports.OffPageLinkNode = void 0;
var react_1 = __importStar(require("react"));
var index_1 = require("../../index");
var util_1 = require("../../util");
var constants_1 = require("../../constants");
var OffPageLinkNode = function (props) {
    ...
    var dx = Math.min(Math.tan(Math.PI / 6) * (width / 2), height / 4);
    var path = [
        ['M', constants_1.NODE_PADDING, constants_1.NODE_PADDING],
        ['L', width - 2 * constants_1.NODE_PADDING, constants_1.NODE_PADDING],
        ['L', width - 2 * constants_1.NODE_PADDING, height - dx],
        ['L', width / 2, height - 2 * constants_1.NODE_PADDING],
        ['L', constants_1.NODE_PADDING, height - dx],
        ['Z'],
    ];
...
exports.OffPageLinkNode = OffPageLinkNode;
