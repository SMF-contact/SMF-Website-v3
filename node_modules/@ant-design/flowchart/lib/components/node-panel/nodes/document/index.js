...
var DocumentNode = function (props) {
    ...
    var path = [
        ...
        [
            ...
            height - 2 * constants_1.NODE_PADDING - 2 * bezierY,
            width / 2 + bezierX,
            height - 2 * constants_1.NODE_PADDING - 2 * bezierY,
        ],
        ['', width / 2, height - 2 * constants_1.NODE_PADDING - bezierY],
        ['S', width / 4, height - 2 * constants_1.NODE_PADDING, constants_1.NODE_PADDING, height - 2 * constants_1.NODE_PADDING - 2 * bezierY],
        ['L', constants_1.NODE_PADDING, constants_1.NODE_PADDING], // top-left
    ];
