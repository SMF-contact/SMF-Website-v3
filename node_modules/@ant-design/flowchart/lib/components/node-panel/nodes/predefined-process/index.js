...
exports.PredefinedProcessNode = void 0;
var react_1 = __importStar(require("react"));
var index_1 = require("../../index");
var util_1 = require("../../util");
var constants_1 = require("../../constants");
var PredefinedProcessNode = function (props) {
    ...
    var path1 = [
        ['M', struckOffset, constants_1.NODE_PADDING],
        ['L', struckOffset, height - 2 * constants_1.NODE_PADDING],
    ];
    var path2 = [
        ['M', width - struckOffset, constants_1.NODE_PADDING],
        ['L', width - struckOffset, height - 2 * constants_1.NODE_PADDING], // right-center
    ];
    return (react_1.default.createElement("svg", { viewBox: "0 0 ".concat(width, " ").concat(height), xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%" },
        ...
        react_1.default.createElement("path", { d: (0, util_1.createPath)(path1), stroke: stroke }),
        react_1.default.createElement("path", { d: (0, util_1.createPath)(path2), stroke: stroke }),
...
exports.PredefinedProcessNode = PredefinedProcessNode;
