...
var FormItemWrapper = function (props) {
    ...
    var updater = (0, react_1.useMemo)(function () {
        return (dependencies === null || dependencies === void 0 ? void 0 : dependencies.length) ? (0, util_1.makeUpdaterByDependencies)(dependencies, setUpdateReasonField) : undefined;
    }, [dependencies]);
