import type { IGraphCommandService, IModelService } from '@antv/xflow';
...
export declare namespace NsJsonSchemaFormModel {
    ...
    const useModel: (model: IModelService) => Promise<import("@antv/xflow").NsModel.IModel<IState>>;
}
...
export declare const useJsonSchemaFormModel: (props: IProps) => {
    ...
    setState: import("@antv/xflow").NsModel.ISetValue<NsJsonSchemaFormModel.IState>;
    model: import("@antv/xflow").RxModel<NsJsonSchemaFormModel.IState>;
