import type { IToolbarOptions } from '@antv/xflow';
...
export declare const useToolbarModel: (props: IToolbarProps) => {
    ...
    setState: import("@antv/xflow").NsModel.ISetValue<NsToolbarModel.IState>;
    toolbarModel: import("@antv/xflow").RxModel<NsToolbarModel.IState>;
};
export {};
