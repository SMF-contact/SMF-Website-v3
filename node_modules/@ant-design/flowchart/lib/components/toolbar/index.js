...
var ToolbarPanel = function (props) {
    ...
    return (react_1.default.createElement(xflow_1.CanvasToolbar, { className: className, layout: layout, config: toolbarConfig, style: __assign({ borderBottom: '1px solid #ccc' }, style), position: position }));
};
