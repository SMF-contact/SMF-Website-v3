...
.xflow-json-form .tabs .ant-tabs-nav .ant-tabs-nav-list .ant-tabs-tab-active .ant-tabs-tab-btn {
...
.flowchart-json-schema-form {
  border-left: 1px solid #d9d9d9;
}
.flowchart-json-schema-form-header {
  display: flex;
  justify-content: space-evenly;
  background: #fff;
  border-bottom: 1px solid #d9d9d9;
}
.flowchart-json-schema-form-header-title {
  font-size: 16px;
}
.flowchart-json-schema-form-footer {
  display: flex;
  justify-content: space-evenly;
  background: #fff;
  border-top: 1px solid #d9d9d9;
}
.flowchart-json-schema-form-footer-title {
  font-size: 16px;
}
.text-truncate {
  overflow: hidden;
...
.xflow-node-panel-header-title {
  font-size: 16px;
}
.xflow-node-panel-header-search {
  width: 100%;
  padding: 0px 12px;
}
...
.xflow-node-panel-node-wrapper {
  display: flex;
  justify-content: center;
  cursor: pointer;
}
.xflow-node-panel .ant-collapse-content {
  border-top: none;
}
.flowchart-node-panel-collpase {
  transition: left 0.5s;
}
.flowchart-node-panel-collpase-wrapper {
  position: relative;
  width: 100%;
  height: 100%;
}
.flowchart-node-panel-collpase-nodes {
  overflow: hidden;
  overflow-y: auto;
  border-right: 1px solid #d9d9d9;
}
.flowchart-node-panel-collpase-icon {
  position: absolute;
  z-index: 99;
  width: 20px;
  color: #aaa;
...
.flowchart-node-panel-collpase-icon:hover {
  color: #2b84c0;
}
.x6-dropdown {
  position: absolute;
...
.flowchart-toolbar-root {
  display: flex;
  justify-content: space-between;
  width: 100%;
}
.flowchart-toolbar-root.horizontal-center {
  justify-content: center;
}
.flowchart-toolbar-root.vertical {
  flex-direction: column;
}
.flowchart-toolbar-root .x6-toolbar.x6-toolbar-hover-effect {
  align-items: center;
  height: 100%;
}
.flowchart-toolbar-root .x6-toolbar-content {
  height: 100%;
}
.flowchart-toolbar.vertical {
  width: 32px;
  height: auto;
...
.flowchart-toolbar.vertical .x6-toolbar.x6-toolbar-hover-effect {
  height: auto;
  padding: 8px 0;
}
.flowchart-toolbar.vertical .x6-toolbar-content-inner,
.flowchart-toolbar.vertical .x6-toolbar-group {
  flex-direction: column;
}
.flowchart-toolbar.vertical .x6-toolbar-item {
  margin: 0;
  padding: 6px 8px;
  color: #595959;
}
.flowchart-toolbar.horizontal .x6-toolbar.x6-toolbar-hover-effect {
  height: 40px;
  line-height: 40px;
}
