...
import { IGraphCommandService, IModelService, NsGraph, IPosition, NsJsonSchemaForm, IToolbarLayout, IAppDestroy, IAppConfigReady, IApplication } from '@antv/xflow';
...
export declare type Command = 'undo-cmd' | 'redo-cmd' | 'front-node' | 'back-node' | 'save-graph-data' | 'multi-select' | 'add-group' | 'del-group' | 'graph-toggle-multi-select' | 'graph-copy-selection' | 'graph-paste-selection';
...
export declare type ContextMenuPanelProps = Pick<BaseProps, 'show'>;
