...
var Toolbar = function (_a) {
    ...
    var _e = (0, useFullscreen_1.default)(container), fullscreen = _e[0], toggleFullscreen = _e[1];
    // 获取当全屏时的窗口大小
    ...
    if (renderIcon) {
        ...
        if (!((_c = (_b = renderIcon
            ...
            utils_1.Log.warn("renderIcon \u7528\u6CD5\u5DF2\u7ECF\u5347\u7EA7\uFF0CrenderIcon(zoomIn, xx) => renderIcon({zoomIn, xx})");
        }
        return renderIcon({
            zoomIn: zoomIn,
            zoomOut: zoomOut,
...
var createToolbar = function (_a) {
    ...
    react_dom_1.default.render(react_1.default.createElement(Toolbar, { graph: graph, container: container, toolbarCfg: toolbarCfg }), mountPoint);
    // @ts-ignore
