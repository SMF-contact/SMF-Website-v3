...
function useL7Plot(Ctor, config) {
    var plotRef = (0, react_1.useRef)();
    var plotConfig = (0, react_1.useRef)();
    var containerRef = (0, react_1.useRef)(null);
    var onReady = config.onReady;
    // updateOption/changeData/updateMap
    (0, react_1.useEffect)(function () {
        if (!plotRef.current || !plotConfig.current || (0, util_1.isEqual)(plotConfig.current, config))
            return;
        ...
        updateMap = !(0, util_1.isEqual)(currentMap, inputMap);
        changeData = !(0, util_1.isEqual)(currentSource, inputSource);
        updateOption = !(0, util_1.isEqual)(currentConfig, inputConfig);
        if (updateMap && inputMap) {
            var updateMapConfig = (0, util_1.pick)(inputMap, ['center', 'pitch', 'rotation', 'zoom', 'style']);
        ...
        plotConfig.current = (0, util_2.deepCloneMapConfig)(config);
    }, [config]);
    (0, react_1.useEffect)(function () {
